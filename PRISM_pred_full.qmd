...
pred_fold <- "//objectstore2.nrs.bcgov/ffec/Mosaic_Yukon/operational/worldclim/tmin/feb/Predictions/"
data_folder <- "//objectstore2.nrs.bcgov/ffec/Mosaic_Yukon/operational/worldclim/prec/feb/shift16_32/"
...
```{python}
G = torch.jit.load("//objectstore2.nrs.bcgov/ffec/Mosaic_Yukon/operational/worldclim/tmin/feb/Generators/Generator_100.pt", map_location=torch.device('cuda:0'))
device = "cuda"
...
# have to change this
wc <- rast("//objectstore2.nrs.bcgov/ffec/Mosaic_Yukon/full_domain/tmin_03_WorldClim_coarse_focal_max_w15.nc")
plot(wc)
