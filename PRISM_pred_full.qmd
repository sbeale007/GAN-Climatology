...
pred_fold <- "C:/Users/SBEALE/Desktop/operational/tmax/sep/Predictions/gen1/"
data_folder <- "C:/Users/SBEALE/Desktop/operational/tmax/sep/shift16_32/"
...
worldclim <- rast(paste(data_folder, c("worldclim_train.nc", "worldclim_mask_train.nc"), sep=""))
...
```{python}
G = torch.jit.load("C:/Users/SBEALE/Desktop/operational/tmax/sep/Generators/gen1/Generator_100.pt", map_location=torch.device('cuda:0'))
device = "cuda"
...
unstand_mean <- 15.656523
unstand_std <- 5.0113034

res_us <- (res * unstand_std) + (unstand_mean)
plot(res_us)

writeCDF(res_us, paste0(pred_fold, "GAN_gen100.nc"), varname='tmax', overwrite = T)
```
...
writeCDF(pred.crop, paste0(pred_fold, "GAN_gen100.nc"), varname='tmax', overwrite=TRUE)
