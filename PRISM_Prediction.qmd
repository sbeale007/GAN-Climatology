...
data_folder <- "C:/Users/SBEALE/Desktop/tmax/tmax_march_nonan_small/"

hrcovs <- rast(paste(data_folder,c("dem_yuk.nc", "lat_yuk.nc","lon_yuk.nc","coast_yuk.nc"), sep = ""))

plot(hrcovs)

wrf <- rast(paste0(data_folder, "wrf_yuk.nc"))
#wrf <- crop(wrf,hrcovs)
dim(wrf)
dim(hrcovs)
plot(wrf)
...
```{python}
G = torch.jit.load("C:/Users/SBEALE/Desktop/Generators/generator_bc_nonan/Generator_230.pt")
device = "cuda"
...
writeRaster(res_us, "C:/Users/SBEALE/Desktop/check/GAN_Preds_June21_stand_gen230_large.tif", overwrite = T)
```
