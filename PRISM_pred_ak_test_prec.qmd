...
pred_fold <- "C:/Users/SBEALE/Desktop/GAN Predictions/prec/worldclim/thufir_runs/prec_march_tiling16/gen1/"
data_folder <- "C:/Users/SBEALE/Desktop/GAN Data/prec/worldclim/full_domain_shift16/"
...
for filepath in glob.iglob('C:/Users/SBEALE/Desktop/Generators/thufir_runs/prec_march_tiling16/gen1/*.pt'):
...
ncol = len(preds.shape[1])
nrow = len(preds.shape[2])
...
preds <- preds[1:dim(preds)[1],1:rast_dim[1],1:rast_dim[2]]
values(res) <- preds
# plot(preds)
...
writeCDF(pred.crop, paste0(pred_fold, "GAN_prec_march_focal_nan=0_allgens_crop.nc"), varname='prec', overwrite=TRUE)
